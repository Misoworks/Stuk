...
fn inspect_capabilities(capabilities: PlatformCapabilities) -> Vec<CapabilityInspection> {
    vec![
        ...
        capability("tray_icons", capabilities.tray_icons),
        capability("autostart", capabilities.autostart),
        capability("global_shortcuts", capabilities.global_shortcuts),
        capability("deep_links", capabilities.deep_links),
        capability("single_instance", capabilities.single_instance),
        capability("native_messaging", capabilities.native_messaging),
        capability("secure_storage", capabilities.secure_storage),
        capability("credential_storage", capabilities.credential_storage),
